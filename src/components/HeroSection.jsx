...
const HeroSection = () => {
  return (
    <section className="hero-section">
      <div className="w-full bg-center bg-cover h-[35rem] mx-auto bg-[url('assest/hero_image.jpg')]">
        <div className=' '>
          <div className='px-0'>
            <div className="flex items-center justify-center w-full h-[35rem] bg-gray-900 bg-opacity-50">
              <div className="mx-10 mt-10 lg:mt-20">
                <h1 className=" text-white ">Transform Lives through the Power of Giving</h1>
                <p className="max-w-2xl mt-5 font-sans font-bold leading-none  text-white sm:text-sm lg:text-md lg:my-8">
